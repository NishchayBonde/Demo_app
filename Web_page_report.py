...
# Example usage
website_link = "https://openai.com/policies/usage-policies"
domain_name = extract_domain(website_link)
print(domain_name)
...
if __name__ == '__main__':
    ...
    for pdf_file in pdf_files:
        ...
        filename = 'output_web/' + pdf_file.replace('.pdf', '.txt')
...
soup = BeautifulSoup("<html><head><title>Consolidated Policies</title></head><body></body></html>", "html.parser")
...
with open('web_report.html', 'w') as file:
